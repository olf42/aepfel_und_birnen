...
export default class extends Phaser.Scene {
    ...
    create () {
        ...
        // // level fore and background
        this.tempel = this.add.image(640, 335, 'bg2')
        // // this.tempel.setAlpha(0.2)
        // this.tempel.setDepth(0)
        // // this.tempel.setPosition(-.5,-.5)

        this.ground = this.matter.add.image(640, 768-75, 'ground2', null,  { isStatic: true})
        this.ground.setAngle(-2)
        // this.ground.rotation = 30
        ...
        this.pear = this.matter.add.image(700, 80, this.sys.game.im.random("pears"))
        this.pear.setBounce(0.5)
        this.pear.setBody({
            type: 'circle',
            radius: 48
        })
        this.pear.setVelocityX(-2)
        this.pear.setFrictionAir(0)
