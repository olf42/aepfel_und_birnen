...
export default class extends Phaser.Scene {
    ...
    addLine (line, font, delay, center=640) {
        this.timer += delay
    ...
    addBlock (block, delay, center=640) {
        this.addLine(block.header, '24px Ultra', delay, center)
        this.timer += 1000
        for (const line of block.lines) {
            this.addLine(line, '24px Brr Serif', 800, center)
        }
    }
    ...
    create () {
        ...
        this.addLine('diggr präsentiert',  '36px Bree Serif', 0)
        this.addLine('ein "the peargroup" Spiel', '36px Bree Serif', 3000)
        this.addLine('Äpfel und Birnen', '48px Ultra', 4000)
